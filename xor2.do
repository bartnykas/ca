...
force -deposit i_bit0 0 0
force -deposit i_bit1 0 0

force -deposit i_bit0 0 10
force -deposit i_bit1 0 10

force -deposit i_bit0 0 20
force -deposit i_bit1 1 20

force -deposit i_bit0 1 30
force -deposit i_bit1 0 30

force -deposit i_bit0 1 40
